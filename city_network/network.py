...
from city_network.utils import graph_from_shapes, connect_graph
from schemas import ConnectionMetaData, NetworkMetaData, NodeMetaData
...
class Network:
    def __init__(self, network_meta_data: NetworkMetaData):
        ...
        self.transit_nodes = set().union(*transit_nodes)
